module.exports = [
"[project]/quiz-app/.next-internal/server/app/api/submit-quiz/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/quiz-app/src/lib/database.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/quiz-app/src/lib/quizData.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/quiz-app/src/app/api/submit-quiz/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/quiz-app/src/lib/database.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$quizData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/quiz-app/src/lib/quizData.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initDatabase"])();
        const body = await request.json();
        const { answers, userDetails } = body;
        // Calculate score
        let score = 0;
        __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$quizData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["quizQuestions"].forEach((question, index)=>{
            if (answers[index] === question.correctAnswer) {
                score++;
            }
        });
        // Save to database
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveQuizResult"])({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            score,
            totalQuestions: __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$quizData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["quizQuestions"].length,
            percentage: Math.round(score / __TURBOPACK__imported__module__$5b$project$5d2f$quiz$2d$app$2f$src$2f$lib$2f$quizData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["quizQuestions"].length * 100),
            passed: score >= 11,
            resultId: result
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3aca216e._.js.map